...
#include <unistd.h>
#include <ros/ros.h>
#include <p3at_tutorial/KeyboardMessage.h>
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher publisher = n.advertise<p3at_tutorial::KeyboardMessage>("keyboard_topic", 1);
    char c;
    KeyboardInput input;
...
void publishKey(ros::Publisher &publisher, char c)
{
    p3at_tutorial::KeyboardMessage msg;
